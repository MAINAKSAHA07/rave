...
migrate((db) => {
  ...
  collection.listRule = "@request.auth.role = 'super_admin' || @request.auth.role = 'admin' || email = @request.auth.email"
  collection.viewRule = "@request.auth.role = 'super_admin' || @request.auth.role = 'admin' || email = @request.auth.email"
