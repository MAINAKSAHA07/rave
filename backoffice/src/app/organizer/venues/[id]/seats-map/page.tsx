            ...
            >
              {seats.map((seat) => {
                ...
                return (
                  <div
                    key={seat.id}
                    className={`absolute cursor-grab active:cursor-grabbing bg-blue-500 text-white rounded px-2 py-1 text-xs font-medium shadow-md hover:bg-blue-600 transition-colors ${
                      activeSeatId === seat.id ? 'ring-2 ring-blue-300 z-50' : 'z-10'
                    }`}
                    style={{
                      left: `${x}px`,
                      top: `${y}px`,
