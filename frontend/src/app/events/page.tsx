      ...
      <div className="max-w-[428px] mx-auto bg-white min-h-screen">
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 p-4">
          <div className="relative">
            <Input
              ...
              className="w-full pl-4 pr-12 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-0"
            />
        ...
        <div className="px-4 py-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold text-gray-900">Event for you</h2>
        ...
        {specialDeals.length > 0 && (
          <div className="px-4 py-6 bg-gray-50">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-bold text-gray-900">Special Deal</h2>
              <Link href="/events" className="text-teal-600 text-sm font-medium">
                See More
              </Link>
            </div>
                ...
                >
                  <div className="flex">
                    ...
                    <div className="flex-1 p-3">
                      ...
                      <h3 className="text-sm font-bold text-gray-900 mb-1 line-clamp-1">{event.name}</h3>
                      <p className="text-xs text-gray-600 mb-2">
                        {new Date(event.event_date || event.start_date).toLocaleDateString('en-IN', {
                          day: 'numeric',
                          month: 'long',
