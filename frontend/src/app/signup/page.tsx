    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-teal-500 to-emerald-500">
      <Card className="w-full max-w-md bg-white border-2 border-gray-200 shadow-xl rounded-2xl">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-gray-700">Sign up to start buying tickets</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-gray-700 font-medium">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white border-2 border-gray-300 focus:border-teal-500 rounded-xl text-gray-900"
              />
              <p className="text-xs text-gray-700">Must be at least 8 characters</p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="passwordConfirm" className="text-gray-900 font-semibold">Confirm Password</Label>
              <Input
                id="passwordConfirm"
                type="password"
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/login" className="text-teal-600 hover:text-teal-700 hover:underline font-semibold">
              Sign in
            </Link>
          </div>
        </CardContent>
