        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-white">₹{(stats.totalRevenue / 100).toLocaleString()}</div>
            ...
            <Card className="col-span-4 bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg">
                <CardHeader>
                    <CardTitle className="text-white">Overview</CardTitle>
                </CardHeader>
                <CardContent className="pl-2">
                    <div className="h-[350px] flex items-center justify-center bg-white/5 rounded-md border border-dashed border-white/20">
                        <p className="text-gray-400">Sales Analytics Chart (D3.js) will go here</p>
                    </div>
                </CardContent>
            </Card>
        </div>
